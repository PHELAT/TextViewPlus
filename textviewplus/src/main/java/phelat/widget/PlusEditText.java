...
public class PlusEditText extends AppCompatEditText {

    private static final String TAG = "TextViewPlus:EditText";

    public PlusEditText(Context context) {super(context);}

    public PlusEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
        setFont(context, attrs);
    }

    public PlusEditText(Context context, AttributeSet attrs, int defStyle) {
